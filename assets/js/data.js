...
window.DB = (function () {
  ...
  /* ---------- 12) Notifications ---------- */
  const notis = [
    { ic:'⚠️', t:'หมูสับต่ำกว่าจุดสั่งซื้อ', d:'เหลือ 3.2 กก. (ขั้นต่ำ 8 กก.)', time:'12 นาทีที่แล้ว', cls:'badge-bad' },
    { ic:'🦐', t:'กุ้ง/ปลาหมึกหมด', d:'กะเพราทะเลถูกปิดขายอัตโนมัติ', time:'1 ชม.ที่แล้ว', cls:'badge-bad' },
    { ic:'🎯', t:'ยอดขายวันนี้เกินเป้ารายวันแล้ว', d:`฿${(18520).toLocaleString()} จากเป้า ฿16,129`, time:'2 ชม.ที่แล้ว', cls:'badge-good' },
    { ic:'🤖', t:'AI พบโอกาสเพิ่มกำไร 3 ข้อ', d:'ปรับราคา / Bundle / ย้ายงบโฆษณา', time:'เช้านี้', cls:'badge-ai' }
  ];
